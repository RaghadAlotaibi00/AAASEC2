...
!(https://docs.bfl.ml/api_integration/mcp_integration)[Black Forest Labs] or !(Fal AI)[https://fal.ai/docs/documentation/setting-up/mcp], in this case submit the code and the artifact (the generated images)
